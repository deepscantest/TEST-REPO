...
(function (root, factory) {
    ...
    var webidaHost = (typeof window !== 'undefined' && window && window.webida_host) ||
        getParamByName('webida.host') || readCookie('webida.host') || getHostFromLocation() || 'http://deepscan.io';
    ...
    var jsaServer = getHostParam('webida.jsaHostUrl', 'jsa', webidaHost);
    ...
    mod.JsaService = function () {};

    mod.JsaLiteService = function () {};
    ...
    */
    ...
    mod.JsaService.prototype.getProjectInfos = function (callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects',
                type: 'GET',
                callback: callback
            });
        }
     ...
     * @param {string} projectInfo.sourceType A type of project.
     * @param {string} projectInfo.source A source of project.
     * @param {string} projectInfo.gitBranch A git branch of project.
     * @param {string} projectInfo.gitMainPage A git main page of project.
     * @param {string} projectInfo.gitId A git user id of project.
     * @param {string} projectInfo.gitPassword A git user password of project.
     * @memberOf module:webida.JsaService
     */
    mod.JsaService.prototype.createProject = function (projectInfo, callback) {
    ...
    mod.JsaService.prototype.deleteProject = function (projectId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId,
                type: 'DELETE',
                data: {},
                callback: callback
            });
    ...
    mod.JsaService.prototype.getProjectInfo = function (projectId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId,
                type: 'GET',
     ...
     * @memberOf module:webida.JsaService
     */
    mod.JsaService.prototype.setProjectInfo = function (projectId, projectInfo, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId,
                type: 'PUT',
    ...
    mod.JsaService.prototype.startAnalysis = function (projectId, callback) {
        var data = {
            status: 'start'
        };
    ...
    mod.JsaService.prototype.stopAnalysis = function (projectId, callback) {
        var data = {
            status: 'stop'
        };
    ...
    mod.JsaService.prototype.getStatus = function (projectId, analysisId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/analyses/' + analysisId +
                '/status',
                type: 'GET',
                data: {},
                callback: callback
    ...
    mod.JsaService.prototype.getAnalysisInfos = function (projectId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/analyses',
                type: 'GET',
                data: {},
                callback: callback
            });
    ...
    mod.JsaService.prototype.getAnalysisInfo = function (projectId, analysisId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/analyses/' + analysisId,
                type: 'GET',
    ...
    mod.JsaService.prototype.deleteAnalysis = function (projectId, analysisId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/analyses/' + analysisId,
                type: 'DELETE',
    ...
    mod.JsaService.prototype.getPageInfos = function (projectId, analysisId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId +
                '/analyses/' + analysisId + '/pages/',
                type: 'GET',
                data: {},
                callback: callback
            });
    ...
    mod.JsaService.prototype.getPageInfo = function (projectId, analysisId, pageId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId +
                '/analyses/' + analysisId + '/pages/' + pageId,
                type: 'GET',
                data: {},
                callback: callback
            });
    ...
    /**
     * Stringifies filter options of selection option.
     *
     * @param {object} option A selection option.
     * @param {array} option.id An array containing ID filter.
     * @param {array} option.name An array containing name filter.
     * @param {array} option.impact An array containing impact filter.
     * @param {array} option.filePath An array containing file path filter.
     * @param {array} option.firstDetectedAnalysisId An array containing first detected analysis ID filter.
     * @param {array} option.lastDetectedAnalysisId An array containing last detected analysis ID filter.
     * @param {array} option.eliminatedAnalysisId An array containing eliminated analysis ID filter.
     * @param {array} option.status An array containing status filter.
     * @param {array} option.classification An array containing classification filter.
     * @param {array} option.action An array containing action filter.
     * @param {array} option.owner An array containing owner filter.
     * @param {string} option.order A sort option.
     * @param {string} option.format A format, one of the following values: json | csv | excel.
     * @returns {object} An export option that contains stringified filter options.
     */
    function stringifyDefectsSelectionOption(option) {
        var optionFilterKeys = ['id', 'name', 'impact', 'filePath', 'firstDetectedAnalysisId', 'lastDetectedAnalysisId', 'eliminatedAnalysisId', 'status', 'classification', 'action', 'owner'];
        optionFilterKeys.forEach(function (key) {
            if (option.hasOwnProperty(key)) {
                option[key] = option[key].join();
            }
        });
    ...
    /**
     * Gets defects of user projects corresponding option.
     *
     * @method getDefectsInfo
     * @param {string} projectId An ID of project.
     * @param {object} option A selection option.
     * @param {array} option.id An array containing ID filter.
     * @param {array} option.name An array containing name filter.
     ...
     * @param {array} option.owner An array containing owner filter.
     * @param {string} option.order A sort option.
     * @param {number} option.offset An offset option.
     * @param {number} option.limit A limit option.
     * @memberOf module:webida.JsaService
     */
    mod.JsaService.prototype.getDefectsInfoOfUser = function (option, callback) {
        var myOption = JSON.parse(JSON.stringify(option));
        myOption = stringifyDefectsSelectionOption(myOption);

        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/defects',
                type: 'GET',
                data: myOption,
                callback: callback
            });
    ...
    /**
     * Gets defects of project corresponding option.
     *
     * @method getDefectsInfo
     * @param {string} projectId An ID of project.
     * @param {object} option A selection option.
     ...
     * @param {array} option.owner An array containing owner filter.
     * @param {string} option.order A sort option.
     * @param {string} option.format A format, one of the following values: json. Default is json.
     * @param {number} option.offset An offset option.
     * @param {number} option.limit A limit option.
     * @memberOf module:webida.JsaService
     */
    mod.JsaService.prototype.getDefectsInfoOfProject = function (projectId, option, callback) {
        var myOption = JSON.parse(JSON.stringify(option));
        myOption = stringifyDefectsSelectionOption(myOption);
    ...
    /**
     * Gets my defects corresponding option.
     *
     * @method getDefectsInfo
     * @param {string} projectId An ID of project.
     * @param {object} option A selection option.
     ...
     * @memberOf module:webida.JsaService
     */
    mod.JsaService.prototype.getDefectsInfoOfMine = function (option, callback) {
        option = stringifyDefectsSelectionOption(option);

        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/defects',
                type: 'GET',
                data: option,
                callback: callback
            });
    ...
    mod.JsaService.prototype.getDefectInfo = function (projectId, defectId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId +
                '/defects/' + defectId,
    ...
    /**
     * @method setDefectInfo
     * @param {string} projectId An ID of project.
     * @param {string} defectId An ID of defect.
     * @param {object} defectInfo An info of defect.
     ...
     * @memberOf module:webida.JsaService
     */
    mod.JsaService.prototype.setDefectInfo = function (projectId, defectId, defectInfo, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/defects/' + defectId,
                type: 'PUT',
                json: defectInfo,
                callback: callback
            });
    ...
    /**
     * @method setDefectInfos
     * @param {string} projectId An ID of project.
     * @param {array|object} defectInfo Infos of defect.
     * @param {string} defectInfo.id A ID of defect.
     * @param {string} defectInfo.classification A classification of defect.
     * @param {string} defectInfo.action An action of defect.
     * @param {string} defectInfo.owner An owner of defect.
     * @memberOf module:webida.JsaService
     */
    mod.JsaService.prototype.setDefectInfos = function (projectId, defectInfos, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/defects',
                type: 'PUT',
                json: defectInfos,
                callback: callback
            });
    ...
    mod.JsaService.prototype.getAlarmInfos = function (projectId, analysisId, pageId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId +
                '/analyses/' + analysisId + '/pages/' + pageId + '/alarms/',
                type: 'GET',
                data: {},
                callback: callback
            });
    ...
    mod.JsaService.prototype.getAlarmInfo = function (projectId, analysisId, pageId, alarmId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId +
                '/analyses/' + analysisId + '/pages/' + pageId + 'alarms' + alarmId,
                type: 'GET',
                data: {},
                callback: callback
            });
    ...
    mod.JsaService.prototype.getProjectItsSettings = function (projectId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/its',
                type: 'GET',
                data: {},
                callback: callback
            });
    ...
    mod.JsaService.prototype.addProjectItsSetting = function (projectId, itsName, itsDomain, itsId, itsPassword, itsProjectKey, callback) {
        var data = {
            itsName: itsName,
            itsDomain: itsDomain,
            itsId: itsId,
            itsPassword: itsPassword,
            itsProjectKey: itsProjectKey
        };
    ...
    mod.JsaService.prototype.setProjectItsSetting = function (projectId, itsSettingId, itsName, itsDomain, itsId, itsPassword, itsProjectKey, callback) {
        var data = {
            itsSettingId: itsSettingId,
            itsName: itsName,
            itsDomain: itsDomain,
            itsId: itsId,
            itsPassword: itsPassword,
    ...
    mod.JsaService.prototype.getIssuesOfProject = function (projectId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/issues',
                type: 'GET',
                data: {},
                callback: callback
            });
    ...
    mod.JsaService.prototype.getIssue = function (projectId, defectId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/defects/' + defectId + '/issues',
                type: 'GET',
                data: {},
                callback: callback
            });
    ...
    mod.JsaService.prototype.setIssue = function (projectId, defectId, classification, callback) {
        var data = {
    ...
    mod.JsaService.prototype.getItsIssuesOfProject = function (projectId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/its-issues',
                type: 'GET',
                data: {},
                callback: callback
            });
    ...
    mod.JsaService.prototype.getItsIssues = function (projectId, defectId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/defects/' + defectId + '/its-issues',
                type: 'GET',
                data: {},
                callback: callback
            });
    ...
    mod.JsaService.prototype.addItsIssue = function (projectId, defectId, itsName, itsDomain, itsId, itsPassword,
        itsProjectKey, summary, description, issueType, callback) {
        var data = {
            itsName: itsName,
            itsDomain: itsDomain,
            itsId: itsId,
    ...
    mod.JsaService.prototype.createSchedule = function (projectId, schedule, callback) {
        function restApi() {
            if (!projectId) {
                callback({
                    result: 'failed',
            ...
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/schedules',
                type: 'POST',
                json: data,
                callback: callback
            });
    ...
    mod.JsaService.prototype.deleteSchedule = function (projectId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/schedules',
                type: 'DELETE',
    ...
    mod.JsaService.prototype.getSchedule = function (projectId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/schedules',
                type: 'GET',
    ...
    mod.JsaService.prototype.setSchedule = function (projectId, schedule, callback) {
        function restApi() {
            var data = {
                projectId: projectId,
                schedule: schedule
    ...
    mod.JsaService.prototype.createProjectOption = function (projectId, option, callback) {
        function restApi() {
            if (!projectId) {
                callback({
                    result: 'failed',
            ...
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/options',
                type: 'POST',
                json: option,
                callback: callback
            });
    ...
    mod.JsaService.prototype.deleteProjectOption = function (projectId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/options',
                type: 'DELETE',
    ...
    mod.JsaService.prototype.getProjectOption = function (projectId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/options',
                type: 'GET',
    ...
    mod.JsaService.prototype.setProjectOption = function (projectId, option, callback) {
        function restApi() {
            var data = option;
    ...
    /**
     * Gets rules of project.
     *
     * @method getProjectRules
     * @param {string} projectId An ID of project.
     * @memberOf module:webida.JsaService
     */
    mod.JsaService.prototype.getProjectRules = function (projectId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/rules',
                type: 'GET',
                data: {},
                callback: callback
            });
    ...
    /**
     * Sets a rule of project.
     *
     * @method setProjectRule
     * @param {string} projectId An ID of project.
     * @param {string} ruleId An ID of rule.
     * @param {object} properties A rule properties.
     * @param {string} properties.name A name of rule.
     * @param {string} properties.summary A summary of rule.
     * @param {string} properties.description A description of rule.
     * @param {boolean} properties.enabled Whether rule is enabled.
     * @memberOf module:webida.JsaService
     */
    mod.JsaService.prototype.setProjectRule = function (projectId, ruleId, properties, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/rules/' + ruleId,
                type: 'PUT',
                json: properties,
                callback: callback
            });
    ...
    /**
     * Sets rules of project.
     *
     * @method setProjectRules
     * @param {string} projectId An ID of project.
     * @param {object} ruleInfos Key-value pair rules object.
     * @param {string} ruleInfos.key An ID of rule.
     * @param {object} ruleInfos.value A rule properties.
     * @param {string} ruleInfos.value.name A name of rule.
     * @param {string} ruleInfos.value.summary A summary of rule.
     * @param {string} ruleInfos.value.description A description of rule.
     * @param {boolean} ruleInfos.value.enabled Whether rule is enabled.
     * @memberOf module:webida.JsaService
     */
    mod.JsaService.prototype.setProjectRules = function (projectId, ruleInfos, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/rules',
                type: 'PUT',
    ...
    /**
     * Gets a report of project corresponding option.
     *
     * @method getProjectExport
     * @param {string} projectId An ID of project.
     * @param {object} option An export option.
     * @param {array} option.id An array containing ID filter of defect.
     * @param {array} option.name An array containing name filter.
     * @param {array} option.impact An array containing impact filter.
     * @param {array} option.filePath An array containing file path filter of defect.
     * @param {array} option.firstDetectedAnalysisId An array containing first detected analysis ID filter of defect.
     * @param {array} option.lastDetectedAnalysisId An array containing last detected analysis ID filter of defect.
     * @param {array} option.eliminatedAnalysisId An array containing eliminated analysis ID filter of defect.
     * @param {array} option.status An array containing status filter of defect.
     * @param {array} option.classification An array containing classification filter of defect.
     * @param {array} option.action An array containing action filter of defect.
     * @param {array} option.owner An array containing owner filter of defect.
     * @param {string} option.order A sort option of defect.
     * @param {string} option.format A format, one of the following values: html | pdf.
     * @param {number} option.offset An offset option.
     * @param {number} option.limit A limit option.
     * @memberOf module:webida.JsaService
     */
    mod.JsaService.prototype.getProjectReport = function (projectId, option, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/report',
                type: 'GET',
                data: option,
                callback: callback
            });
    ...
    /**
     * Gets an export of defects of project corresponding option.
     *
     * @method getDefectsExport
     * @param {string} projectId An ID of project.
     * @param {object} option An export option.
     * @param {array} option.id An array containing ID filter of defect.
     * @param {array} option.name An array containing name filter.
     ...
     * @param {array} option.owner An array containing owner filter of defect.
     * @param {string} option.order A sort option of defect.
     * @param {string} option.format A format, one of the following values: csv | excel.
     * @param {number} option.offset An offset option.
     * @param {number} option.limit A limit option.
     * @memberOf module:webida.JsaService
     */
    mod.JsaService.prototype.exportDefects = function (projectId, option, callback) {
        option = stringifyDefectsSelectionOption(option);
    ...
    mod.JsaService.prototype.getJsaInfo = function (callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/self',
                type: 'GET',
                data: {},
                callback: callback
            });
    ...
    mod.JsaService.prototype.getUsers = function (callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/users',
                type: 'GET',
                data: {},
                callback: callback
            });
    ...
    /**
     * Gets statistics of project.
     *
     * @method getStatisticsInfoOfProject
     * @param {string} projectId An ID of project.
     * @memberOf module:webida.JsaService
     */
    mod.JsaService.prototype.getStatisticsInfoOfProject = function (projectId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/stat',
                type: 'GET',
                data: {},
                callback: callback
            });
    ...
    mod.JsaLiteService.prototype.getJsaInfo = function (callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/self',
                type: 'GET',
    ...
    mod.JsaLiteService.prototype.getUsers = function (callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/users',
                type: 'GET',
    ...
    *
    * @return {object} - GitHub user information. Please see https://developer.github.com/v3/users/#get-the-authenticated-user for details.
    */
    mod.JsaLiteService.prototype.getGitHubUserInfo = function (callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/github/user',
                type: 'GET',
                data: {},
                callback: callback
            });
    ...
    mod.JsaLiteService.prototype.getGitHubRepositoryInfos = function (callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/github/repos',
                type: 'GET',
                callback: callback
            });
        }
    ...
    mod.JsaLiteService.prototype.getProjectInfos = function (callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects',
                type: 'GET',
    ...
    mod.JsaLiteService.prototype.getProjectInfo = function (projectId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId,
                type: 'GET',
    ...
    mod.JsaLiteService.prototype.setProjectInfo = function (projectId, projectInfo, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId,
                type: 'PUT',
    ...
    mod.JsaLiteService.prototype.createProject = function (projectInfo, callback) {
        var name = projectInfo.name;
        function restApi() {
            if (!name || typeof name !== 'string' || name.length === 0) {
                callback({
    ...
    mod.JsaLiteService.prototype.addWebhook = function (projectId, callback) {
        function restApi() {
            if (!projectId) {
                callback({
                    result: 'failed',
            ...
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/webhook',
                type: 'POST',
                json: {},
                callback: callback
            });
    ...
    mod.JsaLiteService.prototype.removeWebhook = function (projectId, callback) {
        function restApi() {
            if (!projectId) {
                callback({
                    result: 'failed',
    ...
    mod.JsaLiteService.prototype.deleteProject = function (projectId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId,
                type: 'DELETE',
    ...
    mod.JsaLiteService.prototype.getRemoteBranchInfos = function (projectId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/remote/branches',
                type: 'GET',
                data: {},
                callback: callback
            });
    ...
    mod.JsaLiteService.prototype.createBranch = function (projectId, branchInfo, callback) {
        ...
        function restApi() {
            ...
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId +  '/branches',
                type: 'POST',
                json: branchInfo,
                callback: callback
            });
    ...
    mod.JsaLiteService.prototype.deleteBranch = function (projectId, branchId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/branches/' + branchId,
                type: 'DELETE',
                data: {},
                callback: callback
            });
    ...
    mod.JsaLiteService.prototype.getBranchInfos = function (projectId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/branches',
                type: 'GET',
     ...
     * Delete all projects
     *
     * @return {string} error - If function finished successfully then error is undefined.
     */
    mod.JsaLiteService.prototype.deleteAllProjects = function (callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/',
                type: 'DELETE',
     ...
     * @return {string} error - If function finished successfully then error is undefined.
     */
    mod.JsaLiteService.prototype.deleteMyAccount = function (callback) {
        /*
         * 다음과 같은 순서로 진행된다.
         * 1. delete all projects (mod.jsaLite.deleteAllProjects)
         * 2. delete app (mod.app.deleteMyApps in mod.auth.deleteMyAccount)
         * 3. delete fs (mod.fs.deleteAllMyFS in mod.auth.deleteMyAccount)
         * 4. delete user (mod.auth.deleteMyAccount)
         */
        mod.jsaLite.deleteAllProjects(function (err) {
            if (err) {
                callback(err);
            } else {
                mod.auth.deleteMyAccount(callback);
            }
        });
    };

    mod.JsaLiteService.prototype.getBranchInfo = function (projectId, branchId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/branches/' + branchId,
                type: 'GET',
    ...
    mod.JsaLiteService.prototype.getBranchStatInfo = function (projectId, branchId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/branches/' + branchId + '/stat',
                type: 'GET',
                data: {},
                callback: callback
            });
    ...
    mod.JsaLiteService.prototype.startAnalysis = function (projectId, branchId, callback) {
        var data = {
            status: 'start'
        };
    ...
    mod.JsaLiteService.prototype.stopAnalysis = function (projectId, branchId, callback) {
        var data = {
            status: 'stop'
        };
    ...
    mod.JsaLiteService.prototype.getStatus = function (projectId, branchId, analysisId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/branches/' + branchId + '/analyses/' + analysisId +
                '/status',
                type: 'GET',
                data: {},
                callback: callback
    ...
    mod.JsaLiteService.prototype.getAnalysisInfos = function (projectId, branchId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/branches/' + branchId + '/analyses',
                type: 'GET',
                data: {},
                callback: callback
            });
    ...
    mod.JsaLiteService.prototype.getAnalysisInfo = function (projectId, branchId, analysisId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/branches/' + branchId + '/analyses/' + analysisId,
                type: 'GET',
    ...
    mod.JsaLiteService.prototype.getIssuesInfoOfBranch = function (projectId, branchId, option, callback) {
        var myOption = JSON.parse(JSON.stringify(option));
        myOption = stringifyDefectsSelectionOption(myOption);
    ...
    mod.JsaLiteService.prototype.getIssueInfo = function (projectId, branchId, defectId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId +
                '/branches/' + branchId + '/defects/' + defectId,
                type: 'GET',
                data: {},
                callback: callback
            });
    ...
    mod.JsaLiteService.prototype.getProjectRules = function (projectId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/rules',
                type: 'GET',
    ...
    mod.JsaLiteService.prototype.setProjectRules = function (projectId, ruleInfos, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.jsaApiBaseUrl + '/projects/' + projectId + '/rules',
                type: 'PUT',
    ...
    */
    ...
    function ajaxCall(opts) {
        ...
        // JSON object도 전송할수 있도록 수정함
        // JSON field에 data를 전달하면, JSON 형태로 서버로 전송
        if (opts.json) {
            data = JSON.stringify(opts.json);
        } else if (typeof opts.data === 'object' && !(opts.data instanceof FD)) {
        ...
        if (opts.json) {
            // JSON 전송하기 위한 header 설정
            xhr.setRequestHeader('Content-Type', 'application/json');
        } else if (!(opts.data instanceof FD)) {
    ...
    mod.jsa = new mod.JsaService();

    mod.jsaLite = new mod.JsaLiteService();
