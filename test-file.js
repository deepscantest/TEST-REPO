...
function generateAnalysisResult(analysisTarget) {
    var analysisResult = {
        ...
        totalLine: analysisTarget.totalLine,
        loc: analysisTarget.loc
    };
...
function analyzePendingTarget() {
    ...
    analysisTarget.totalLine = 0;
    analysisTarget.loc = 0;
    ...
    readline.createInterface({
        ...
        **/
            ...
            analysisTarget.totalLine += parseInt(file.totalLine);
            analysisTarget.loc += parseInt(file.loc);
        }
